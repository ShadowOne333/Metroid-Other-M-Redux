...
3. Then drag and drop your .iso file on to the "Drag ISO file here" script.
...
1. Run the "extract.bat" script by dragging and dropping your your .iso into it.
...
5. Open Gecko Loader, in the "Open DOL" option select the "main.dol" file, in "Open codes" select your .gct file, and then in "Destination" select the patched.dol as the output. Don't change anything from the "Options" section!
...
10. After copying the modified main.dol file, run the "create.bat" script by dragging and dropping your .iso into it.
